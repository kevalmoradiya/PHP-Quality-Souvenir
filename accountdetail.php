...
foreach ($userDetails as $userDetail){
            ...
            <div>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <?php echo $userDetail[1];?>
                    </dd>
                    <dt>
                        Last Name
                    </dt>
                    <dd>
                        <?php echo $userDetail[2];?>
                    </dd>
                    <dt>
                        Phone No
                    </dt>
                    <dd>
                        <?php echo $userDetail[3];?>
                    </dd>
                    <dt>
                       Email
                    </dt>
                    <dd>
                        <?php echo $userDetail[4];?>
                    </dd>
                    <dt>
                        Password
                    </dt>
                    <dd>
                        <?php echo $userDetail[5];?>
                    </dd>
                    <dt>
                        Status
                    </dt>
                    <dd>
                        <?php echo $userDetail[6];?>
                    </dd>
                    <dt>
                       Address
                    </dt>
                    <dd>
                        <?php echo $userDetail[7];?>
                    </dd>
                </dl>
            </div>
           <?php }?>
