...
?>
    ...
    <div class="col-sm-4">
        ...
        <div>
                <a href="managesouvenir.php">Back to List</a>
            </div>
            ...
            <form action="upload.php" method="post" enctype="multipart/form-data">
                   ...
                   <p>
						<label>Name: </label> <input type="text" name="souvenirname">
				   </p>
                   
                <p>
						<label>Price: </label> <input type="text" name="souvenirprice">
				   </p>
                <p>
						<label>Description: </label> <input type="text" name="souvenirdescription">
				   </p>
				   <p>
						<label>Image: </label> <input type="file" name="image">
				   </p>
                <p>
						<label>Quantity: </label> <input type="text" name="souvenirquantity">
				   </p>
                 <p>
						<label>SupplierId: </label> <input type="number" name="supplierid">
				   </p>
                 <p>
						<label>CategoryId: </label> <input type="number" name="categoryid">
				   </p>
               <p>
