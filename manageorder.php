					...
					?>
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                                <?php if($order[3]=="waiting"){?>
                                    <form method="post" action="ordermarkship.php?orderid=<?php echo $order[0];?>">
                                    <p>
                                    <input type="submit" name="shipped" value="Mark Shipped" />
                                    </p>
                                    </form>
                                <?php }?>
