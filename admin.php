        ...
        <div class="col-sm-9 padding-right">
            <div class="login-form">
                ...
                <div class="form-group">
                    <a href="managesouvenir.php" class="btn btn-default add-to-cart">Manage Souvenirs</a>
                </div>
                <div class="form-group">
                    <a href="disableuser.php" class="btn btn-default add-to-cart">Disable User Account</a>
                </div>
                <div class="form-group">
                    <a href="managecategory.php" class="btn btn-default add-to-cart">Manage Category</a>
                </div>
                <div class="form-group">
                    <a href="managesupplier.php" class="btn btn-default add-to-cart">Manage Supplier</a>
                </div>
                <div class="form-group">
                    <a href="manageorder.php" class="btn btn-default add-to-cart">Manage Order</a>
                </div>
