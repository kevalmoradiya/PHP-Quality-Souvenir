        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="total_area">
                    <ul>
                        <li>Cart Sub Total <span><?php echo $_SESSION["total"]?></span></li>
                        <li>GST(15%) <span><?php echo $_SESSION["gst"]?></span></li>
                        <li>Shipping Cost <span>Free</span></li>
                        <li>Total <span><?php echo $_SESSION["alltotal"]?></span></li>
                    </ul>

                    <a href="ordersuccess.php" class="btn btn-default check_out">Place Order</a>
                </div>
            </div>
        </div>
    </div>
